...
def get_args():
    ...
    parser.add_argument('--num_nodes_h1', type = int, default = 45, help = "Number of nodes in hidden layer 1.")
    parser.add_argument('--num_nodes_h2', type = int, default = 30, help = "Number of nodes in hidden layer 2.")
    ...
    parser.add_argument('--val_split',  type = float, default = 0.10, help = "Fraction of validation data.")
    parser.add_argument('--test_split',  type = float, default = 0.20, help = "Fraction of test data.")
